...
class CustomTopo(Topo):
    ...
    def build(self):
        ...
        self.addLink(s1, s2, delay='20ms',cls=TCLink)
        self.addLink(s2, s3, delay='10ms', cls=TCLink)
        self.addLink(s3, s4, delay='20ms', cls=TCLink)
        self.addLink(s4, s1, delay='15ms', cls=TCLink)
